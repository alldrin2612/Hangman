...
def main():
    print("Generating sound effects for Hangman web app...")
    
    # Create sounds directory if it doesn't exist
    os.makedirs("static/sounds", exist_ok=True)
    
    # Create correct.wav - a pleasant rising tone
    generate_sound("static/sounds/correct.wav", [440, 523, 659], 0.3, 0.7)
    
    # Create wrong.wav - a low error sound
    generate_sound("static/sounds/wrong.wav", [220, 196], 0.4, 0.7)
    
    # Create win.wav - a victory fanfare
    generate_sound("static/sounds/win.wav", [440, 554, 659, 880], 1.0, 0.8)
    
    # Create lose.wav - a sad descending tone
    generate_sound("static/sounds/lose.wav", [440, 392, 349, 293], 1.0, 0.7)
